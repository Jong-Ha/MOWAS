            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarScroll">
                    ...
                    <div class="logitem">
                        ...
                        <div class="login">
                            <div class="d-grid gap-2 login loginbox">
                                <div class=" loginbox login underline yellow" style="font-size: 1.2em; color: #FFFFFF; ">로그인
                                </div>
                                <div class=" loginbox login underline yellow" style="font-size: 1.2em; color: #FFFFFF;">마이패이지
                                </div>
                            </div>
                        </div>
