...
<hr/>
<c:set var="i" value="0" />
<c:forEach var="list" items="${map.villBoardLike}">


<div class="cardbox" style="margin-left: 100px;"></a>
                ...
                <div class="card-body carditem" style="padding: 0;">
                    ...
                    <div class="itemBox">
                        ...
                        <div class="villTitle">
                            ...
                            <a href="/commu/getVillBoard?villBoardNum=${list.villBoardNum}&boardCategory=${list.boardCategory}">  ${list.villTitle}</a>
                        </div>
                        <div class="villText">
                                ${list.villText}
                        </div>
