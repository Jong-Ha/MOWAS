...
<script type="text/javascript">
    function pagingSubmit() {
        $("#commentForm").attr('action', '/myPage/getMyCommentLike').attr('method', 'post').submit()
    ...
    $(function () {
        ...
        $(".getMyLikeComment").on("click", function () {
            self.location = "/myPage/getMyCommentLike?userId=" + userId;
        })

        $(".getMyCbRvLikeRecomment").on("click", function () {
                                ...
                                <c:forEach var="list" items="${map.list}">
                                    ...
                                    <c:if test="${list.likeCheck == 'y'}">
                                        <tr>
                                            <td>
                                                <div>
                                                        ${list.boardCategory=='1 ' ? '일정 후기글' : '우리동네 게시글'}
                                                </div>
                                            </td>
                                            <td>
                                                <div>
