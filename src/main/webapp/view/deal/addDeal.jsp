...
<%--&lt;%&ndash;        <div class="col-xs-4 col-xs-2 ">&ndash;%&gt;--%>
<%--&lt;%&ndash;            <strong>파일&ndash;%&gt;--%>
<%--&lt;%&ndash;                <input type="file" name="file" value="파일 첨부">&ndash;%&gt;--%>
<%--&lt;%&ndash;            </strong>&ndash;%&gt;--%>
<%--&lt;%&ndash;        </div>&ndash;%&gt;--%>
<%--&lt;%&ndash;    </div>&ndash;%&gt;--%>
...
<%--&lt;%&ndash;  <p>동네 : <input type="text" name="villCode" value=""/></p>&ndash;%&gt;--%>
<%--    <p><input type="submit" value="저장" class="addDeal"/></p>--%>
<%--&lt;%&ndash;<p><button type="button" class="addDeal">등록</button></p>&ndash;%&gt;--%>
<%--</form>--%>
