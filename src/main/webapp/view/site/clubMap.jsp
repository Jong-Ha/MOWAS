...
<div class="modal-header">
  <a class="navbar-brand back-btn">
    <svg xmlns="http://www.w3.org/2000/svg" style="font-size: 24px;" width="16" height="16" fill="currentColor" class="bi bi-box-arrow-left" viewBox="0 0 16 16">
...
<div class="modal-body">
  ...
  <div class="col-md-4 text-center col-md-offset-1">
    <input type="text" class="villCode" name="villCode" value="" readonly>
    ...
    $.ajax({
      ...
      success: function (vilCode) {
        //$(".searchLocation").html(vilCode);
         //alert(vilCode);
        $("#searchLocation .villCode").val(vilCode)
      }
    })
  }
