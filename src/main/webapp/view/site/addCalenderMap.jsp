...
<script>
    ...
    function getClubVilCode2(longitude, latitude) {
    ...
    function relayout1() {
        ...
        kakao.maps.event.addListener(map2, 'click', function (mouseEvent) {
            ...
            getClubVilCode2(latlng.getLng(), latlng.getLat());
            $('.searchLng').val(latlng.getLng())
            $('.searchLat').val(latlng.getLat())

        });

        getClubVilCode2(${empty param.searchLng?'127.029020621527':param.searchLng}, ${empty param.searchLat?'37.4994558002948':param.searchLat})
