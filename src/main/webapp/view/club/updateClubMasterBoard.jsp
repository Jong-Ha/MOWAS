...
<div class="modal-header">
    <a class="navbar-brand back-btn" data-bs-target="#getClubMasterBoard" data-bs-toggle="modal">
        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-box-arrow-left" viewBox="0 0 16 16">
            <path fill-rule="evenodd" d="M6 12.5a.5.5 0 0 0 .5.5.h8a.5.5 0 0 0 .5-.5v-9a.5.5 0 0 0-.5-.5h-8a.5.5 0 0 0-.5.5v2a.5.5 0 0 1-1 0v-2A1.5 1.5 0 0 1 6.5 2h8A1.5 1.5 0 0 1 16 3.5v9a1.5 1.5 0 0 1-1.5 1.5h-8A1.5 1.5 0 0 1 5 12.5v-2a.5.5 0 0 1 1 0v2z"/>
            ...
            <c:forEach items="${clubMasterBoard.files}" var="i">
                <div class="clubMasterBoardFiles" id="${i.fileName}"
                    ...
                    <button type="button" class="btn position-relative updateImgBox"
                            style="width: 90%;aspect-ratio: 1; border: 1px #ced4da solid; border-radius: 5px; cursor: default">

                        <img src="/resources/${i.fileName}" alt="모임 공지사항 파일"
                             style="object-fit: contain;aspect-ratio: 1;width: 99%;border-radius: 10px;">
