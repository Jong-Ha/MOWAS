...
<head>
    ...
    <script type="text/javascript">
                        ...
                        $.each(JSONData.list, function (index, item) {
                            ...
                            $.each(item.recommentList, function (index2, item) {
                                ...
                                str +=
                                    ...
                                    "<div class='recommentplz' style='margin-left: 254px;'>" +
                                    '<div class="arrow" >' +
        ...
        $(function () {
            ...
            var currantPage = $(".currentPage").val()
            /*댓글*/
        ...
        <div class="usedbox">
            ...
            <div class="thumbnailBox">
                    ...
                    <div class="likebox" style=" height: 250px;">
                        ...
                        <div class="itembox" style="padding: 20px; margin-top: 10px;">
                            ...
                            <div class="clickBox">
                                ...
                                <div class="btn btn-primary position-relative buttonBox likeButton boardlikeButton">
                                ...
                                <div class="btn btn-success chating"
                ...
                <div class="commentContiner">
                    <div class="commentbox shadow-lg" style="width: 100%">
