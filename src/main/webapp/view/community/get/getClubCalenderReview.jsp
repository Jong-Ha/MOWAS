                        ...
                        $.each(JSONData.list, function (index, item) {
                            ...
                            if (item.commentCheck === 'n') {
                                str +=
                                    ...
                                    "<svg xmlns='http://www.w3.org/2000/svg' width='16' height='16' fill='currentColor' class='bi bi-chat-left-quote itmesize chatComment' viewBox='0 0 16 16'>" +
                            ...
                            $.each(item.recommentList, function (index2, item) {
                                ...
                                str +=
                                    ...
                                    "<button type='button' class='btn btn-outline-primary itembutton buttonMargin chatRecomment'>" +
                                    "<svg xmlns='http://www.w3.org/2000/svg' width='16' height='16' fill='currentColor' class='bi bi-chat-left-quote itmesize' viewBox='0 0 16 16'>" +
                                    "<path d='M14 1a1 1 0 0 1 1 1v8a1 1 0 0 1-1 1H4.414A2 2 0 0 0 3 11.586l-2 2V2a1 1 0 0 1 1-1h12zM2 0a2 2 0 0 0-2 2v12.793a.5.5 0 0 0 .854.353l2.853-2.853A1 1 0 0 1 4.414 12H14a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2H2z'/>" +
                                    "<path d='M7.066 4.76A1.665 1.665 0 0 0 4 5.668a1.667 1.667 0 0 0 2.561 1.406c-.131.389-.375.804-.777 1.22a.417.417 0 1 0 .6.58c1.486-1.54 1.293-3.214.682-4.112zm4 0A1.665 1.665 0 0 0 8 5.668a1.667 1.667 0 0 0 2.561 1.406c-.131.389-.375.804-.777 1.22a.417.417 0 1 0 .6.58c1.486-1.54 1.293-3.214.682-4.112z'/>" +
                                    "</svg>" +
                            ...
                            $(".commentplz").html("");
                            $(".commentplz").addClass("animation-init");

                            setTimeout(function () {
                                $(".commentplz").addClass("animation-fade");
                            }, 30);
            ...
            <div class="thumbnailBox">
                ...
                <div class="likebox shadow-lg">
                    <div class="itembox" style="padding: 20px;">
                        <button type="button"
                                class="btn btn-primary position-relative itembutton boardLikeButton">
                            ...
                            <span
                                    class="position-absolute top-0 start-100 translate-middle badge rounded-pill bg-danger boardLikeText"
                        ...
                        <button type="button" class="btn btn-outline-primary itembutton chatBoard">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
