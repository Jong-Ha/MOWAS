						...
						<div class="row textboxrow">
							...
							<div class="col-10">
								...
								<textarea class="form-control" id="exampleFormControlTextarea1"
									rows="3" style="height: 255px;" placeholder="어쩌구저쩌구~~~"></textarea>
							</div>
						</div>
					</div>
				</div>
			...
			<div class="commentbox shadow-lg">
				<div class="commentadd">
					<div class="form-floating">
						...
						<label for="floatingTextarea2">Comments</label> <a href="#"
							class="button addcomment">등록</a>
					</div>
				</div>
				...
				<div class="comment">
					<div class="input-group flex-nowrap commentText shadow-lg">
						<span class="input-group-text" id="addon-wrapping"
							...
							<img src="${pageContext.request.contextPath}/resources/images/pngwing.png" style="width: 20px; margin-right: 10px;" alt="">
							userName
						</span>
