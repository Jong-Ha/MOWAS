                    ...
                    success: function (JSONData, result) {
                        ...
                        $.each(JSONData.list, function (index, item) {
                            ...
                            var str =
                                ...
                                "<div class='input-group flex-nowrap commentText shadow-lg' style='width: 680px;'>"
                            if (item.commentCheck === 'n') {

                                var str2 =
                                    "<span class='input-group-text' id='addon-wrapping' style='width:100px;font-size:0.5em;font-weight: bolder;'>" +
                                    "<img src='/resources/images/pngwing.png' style='width: 20px; margin-right: 10px;' alt=''>" + item.userId +
                                    "</span>" +

                                    "<div class='commentTexts'>" + item.commentText +
                                    "</div>" +

                                    "<div class='commentitembox'>" +
                                    "<div class='commentitem'>" +
                                    "<button type='button' class='btn btn-primary position-relative itembutton buttonMargin'>" +
                                    ...
                                    "</svg>" +
                                    "<span class='position-absolute top-0 start-100 translate-middle badge rounded-pill bg-danger' style='z-index: 1; font-size: 0.5em;'> 99+ </span>" +
                                    "</button>" +
                                    ...
                                    "<div id='reComent' style='margin-top: 10px; margin-bottom: 30px; text-align: -webkit-center; display: none;'>" +
                                    "<textarea name='recommentText' class='form-control addReomment' placeholder='Recomment' style='height: 70px; width: 500px; margin-bottom: 10px;'></textarea>" +
                                    "<button class='btn btn-primary addRecomment' type='button'>대댓글 작성</button>" +
                                    "</div>" +

                                    "<div id='updateComment' style='margin-top: 10px; margin-bottom: 30px; text-align: -webkit-center; display: none;'>" +
                                ...
                                $(".commentplz").append(str + str2);
                            }
                            if (item.commentCheck === 'y') {
                                var str3 = "<h2>삭제 된 댓글 입니다</h2>"

                                $(".allComment").remove();
                                $(".commentplz").append(str + str3);
                            }
                            ...
                            $.each(item.recommentList, function (index2, item) {
                                ...
                                var str4 =
                                    ...
                                    "<span class='input-group-text' style='width: 100px; font-size: 0.5em; font-weight: bolder;'>" +
                                    ...
                                    "</div>" +
                                    "</div>" +
                                    "<div id='updateRecomment' style='margin-top: 10px; margin-bottom: 30px; text-align: -webkit-center; display: none;'>" +
                                ...
                                $(".commentplz").append(str + str2 + str4);
                            })
                        ...
                        $(".updateComment").on("click", function () {
                            $(this).parents(".allComment").find("#updateComment").slideToggle();
                        })


                        $(".addUpdateComment").on("click", function () {

                            var commentText = $(this).parents(".allComment").find(".updateCommentText").val();
                        ...
                        $(".showRecomment").on("click", function () {
                            $(this).parents(".allComment").find("#reComent").slideToggle();
                        })
                        ...
                        $(".addUpdateRecomment").on("click", function () {
                            var recommentNum = $(this).parents(".allComment").find(".recommentNum").val()
                            var recommentText = $(this).parents(".allComment").find(".updateRecommentText").val();
            ...
            <div class="textbox shadow-lg">
                <div class="container">
                    <div class="row textboxrow">
                        ...
                        <div class="col-10">${calenderReview.reviewTitle}</div>
                    </div>


                    <div class="row textboxrow">
                        <div class="col-2">작성자</div>
                        <div class="col-10">${calenderReview.userId}</div>
                    </div>
