                ...
                $.ajax({
                    ...
                    success: function (JSONData, result) {
                        ...
                        $.each(JSONData.list, function (index, item) {
                            ...
                            if (item.commentCheck === 'n') {
                                str +=
                                    ...
                                    "<svg xmlns='http://www.w3.org/2000/svg' width='16' height='16' fill='currentColor' class='bi bi-hand-thumbs-down-fill itmesize'  style='font-size: 2.5em;' viewBox='0 0 16 16'>" +
                        ...
                        $(".hideRecomment").on("click", function () {
                            ...
                            $("."+commentNum).nextUntil(".commentList").slideToggle();
                        })
