                    ...
                    <div class="card-body carditem">
                        ...
                        <div class="itemBox">
                            ...
                            <c:if test="${user.userId  eq villBoard.userId}">
                                <button type="button" class="btn btn-outline-primary update" data-bs-toggle="modal" data-bs-target="#exampleModal2" style="font-size: 0.5em;">
                                    수정
                                </button>
                                <button type="button" class="btn btn-outline-secondary delete " style="font-size: 0.5em;">삭제
                                </button>
                            </c:if>
                            <hr>
