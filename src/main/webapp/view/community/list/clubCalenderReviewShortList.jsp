...
<script type="text/javascript">
    $(function () {
        ...
        $(".update").on("click", function () {
            window.open("/view/community/update/updateClubCalenderReviewShort.jsp", "모임 일정 후기쇼츠 수정",
                "left=300, top=200, width=800px, height=800px, marginwidth=0, marginheight=0, scrollbars=no, scrolling=no, menubar=no, resizable=no"
            )
        });
...
<div class="wap">
    ...
    <nav class="shadow-lg navbar navbar-expand-lg bg-light" style="margin-bottom: 50px;">
        ...
        <button class="btn btn-success btnlf clubCalenderReviewShort" type="submit">모임 일정 쇼츠</button>
