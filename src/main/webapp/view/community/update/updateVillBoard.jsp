        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-xs-8 col-xs-4">
                    <input type="text" class="form-control villTitle" name="villTitle" value="${villBoard.villTitle}"/>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-xs-8 col-xs-4">
					<textarea class="form-control villText" name="villText"
                              style=" height: 200px;  width: 500px;  margin-bottom: 20px;">
                        ${villBoard.villText}
                    </textarea>
                </div>
            </div>
